...
public class TweetDatabase extends ContentProvider {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("CREATE TABLE " + TWEETS_TABLE_NAME + " (" + Tweets._ID + " INTEGER PRIMARY KEY," + AUTHOR_ID
					+ " TEXT," + IMG_URL + " TEXT," + IMAGE_BLOB + " BLOB," + MESSAGE + " TEXT," + SOURCE + " TEXT,"
					+ TWEET_TYPE + " INTEGER," + IN_REPLY_TO_STATUS_ID + " INTEGER," + IN_REPLY_TO_AUTHOR_ID + " TEXT,"
					+ FAVORITED + " INTEGER," + SENT_DATE + " INTEGER," + CREATED_DATE + " INTEGER" + ");");
			db.execSQL("CREATE TABLE " + MENTIONS_TABLE_NAME + " (" + Tweets._ID + " INTEGER PRIMARY KEY," + AUTHOR_ID
					+ " TEXT," + IMG_URL + " TEXT," + IMAGE_BLOB + " BLOB," + MESSAGE + " TEXT," + SOURCE + " TEXT,"
					+ TWEET_TYPE + " INTEGER," + IN_REPLY_TO_STATUS_ID + " INTEGER," + IN_REPLY_TO_AUTHOR_ID + " TEXT,"
					+ FAVORITED + " INTEGER," + SENT_DATE + " INTEGER," + CREATED_DATE + " INTEGER" + ");");
			db.execSQL("CREATE TABLE " + MYTWEET_TABLE_NAME + " (" + Tweets._ID + " INTEGER PRIMARY KEY," + AUTHOR_ID
					+ " TEXT," + IMG_URL + " TEXT," + IMAGE_BLOB + " BLOB," + MESSAGE + " TEXT," + SOURCE + " TEXT,"
					+ TWEET_TYPE + " INTEGER," + IN_REPLY_TO_STATUS_ID + " INTEGER," + IN_REPLY_TO_AUTHOR_ID + " TEXT,"
					+ FAVORITED + " INTEGER," + SENT_DATE + " INTEGER," + CREATED_DATE + " INTEGER" + ");");
		}
